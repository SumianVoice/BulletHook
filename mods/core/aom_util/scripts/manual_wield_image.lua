...
local function new_hud(player)
    pl[player].hud_id = hud_add(player, {
        ...
        alignment = {x=0, y=-1},
        position = {x=0.5, y=1},
        name = "aom_util:manual_wield_image",
        text = "blank.png",
        z_index = -1000,
        scale = {x = 4, y = 4},
        offset = {x = 0, y = 0},
...
function aom_util.manual_wield_image.set_image(player, image_name, params)
    check_player(player)
...
--     aom_util.manual_wield_image.set_image(player, "aom_manual_hud_testrig.png")
-- end)
